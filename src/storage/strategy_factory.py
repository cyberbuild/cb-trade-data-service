...
from storage.path_strategy import StoragePathStrategy, OHLCVPathStrategy
...
class DataTypeRegistry:
    ...
    @classmethod
    def register(cls, data_type: str, strategy_class: Type[StoragePathStrategy]):
        """Register a path strategy class for a specific data type"""
        cls._registry[data_type] = strategy_class
    
    @classmethod
    def get_strategy_class(cls, data_type: str) -> Type[StoragePathStrategy]:
    ...
    @classmethod
    def create_strategy(cls, data_type: str) -> StoragePathStrategy:
...
class PathStrategyFactory:
    ...
    @staticmethod
    def create_strategy_from_context(context: Dict[str, Any]) -> StoragePathStrategy:
